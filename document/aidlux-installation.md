...
4. [安装 OpenClaw-CN](#安装-openclaw-cn)
5. [首次配置](#首次配置)
6. [启动服务](#启动服务)
7. [故障排查](#故障排查)
...
OpenClaw是一个开源的 AI 智能助手系统，支持多渠道消息接入和灵活的技能扩展。在 AidLux 上，我们可以直接在 Linux 环境中安装 OpenClaw-CN，享受完整的 Linux 体验。
